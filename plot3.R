...
dir <- getwd()
pr("Exploratory Data Analysis Course Project 1, part 3 of 4")
...
# Generate plot 3 of 4, save as PNG format file
pr("  generating plot...")
...
legend("topright", names(nexdata[6:8]), cex=0.8, col=c("black", "red", "blue"), lty = 1, bty="y")
